"use strict";var check;module.watch(require('../check'),{default(v){check=v}},0);var parse;module.watch(require('../parse'),{default(v){parse=v}},1);// The `GPOS` table contains kerning pairs, among other things.
...
function parseLookupTable(data, start) {
    ...
    if (lookupType === 2) {
        ...
        const posFormat = p.parseUShort();
        const lookupType = p.parseUShort();
        const offset = p.parseULong();
...
module.exportDefault({ parse: parseGposTable });
