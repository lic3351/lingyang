"use strict";var assert;module.watch(require('assert'),{default(v){assert=v}},0);var hex,unhex;module.watch(require('./testutil'),{hex(v){hex=v},unhex(v){unhex=v}},1);var decode,encode,sizeOf;module.watch(require('../src/types'),{decode(v){decode=v},encode(v){encode=v},sizeOf(v){sizeOf=v}},2);
