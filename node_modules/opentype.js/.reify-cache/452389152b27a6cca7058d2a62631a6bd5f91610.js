"use strict";var assert;module.watch(require('assert'),{default(v){assert=v}},0);var unhex,unhexArray;module.watch(require('../testutil'),{unhex(v){unhex=v},unhexArray(v){unhexArray=v}},1);var gsub;module.watch(require('../../src/tables/gsub'),{default(v){gsub=v}},2);
