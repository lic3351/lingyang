"use strict";var CffEncoding,cffStandardEncoding,cffExpertEncoding,cffStandardStrings;module.watch(require('../encoding'),{CffEncoding(v){CffEncoding=v},cffStandardEncoding(v){cffStandardEncoding=v},cffExpertEncoding(v){cffExpertEncoding=v},cffStandardStrings(v){cffStandardStrings=v}},0);var glyphset;module.watch(require('../glyphset'),{default(v){glyphset=v}},1);var parse;module.watch(require('../parse'),{default(v){parse=v}},2);var Path;module.watch(require('../path'),{default(v){Path=v}},3);var table;module.watch(require('../table'),{default(v){table=v}},4);// The `CFF` table contains the glyph outlines in PostScript format.
...
module.exportDefault({ parse: parseCFFTable, make: makeCFFTable });
