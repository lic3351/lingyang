"use strict";var assert;module.watch(require('assert'),{default(v){assert=v}},0);var Font,Path,Glyph,load,loadSync;module.watch(require('../src/opentype'),{Font(v){Font=v},Path(v){Path=v},Glyph(v){Glyph=v},load(v){load=v},loadSync(v){loadSync=v}},1);
