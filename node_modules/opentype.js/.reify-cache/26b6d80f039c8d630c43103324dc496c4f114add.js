"use strict";var assert;module.watch(require('assert'),{default(v){assert=v}},0);var Font,Glyph,Path;module.watch(require('../src/opentype'),{Font(v){Font=v},Glyph(v){Glyph=v},Path(v){Path=v}},1);var Substitution;module.watch(require('../src/substitution'),{default(v){Substitution=v}},2);
