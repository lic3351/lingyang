"use strict";var assert;module.watch(require('assert'),{default(v){assert=v}},0);var Font,Glyph,Path,loadSync;module.watch(require('../src/opentype'),{Font(v){Font=v},Glyph(v){Glyph=v},Path(v){Path=v},loadSync(v){loadSync=v}},1);
