"use strict";var assert;module.watch(require('assert'),{default(v){assert=v}},0);var hex,unhex;module.watch(require('../testutil'),{hex(v){hex=v},unhex(v){unhex=v}},1);var meta;module.watch(require('../../src/tables/meta'),{default(v){meta=v}},2);
