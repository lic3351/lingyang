"use strict";var assert;module.watch(require('assert'),{default(v){assert=v}},0);var unhex;module.watch(require('./testutil'),{unhex(v){unhex=v}},1);var Parser;module.watch(require('../src/parse'),{Parser(v){Parser=v}},2);
